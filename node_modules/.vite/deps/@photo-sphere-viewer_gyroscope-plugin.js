...
// node_modules/@photo-sphere-viewer/gyroscope-plugin/index.module.js
...
var _GyroscopeUpdatedEvent = class _GyroscopeUpdatedEvent2 extends TypedEvent {
  /** @internal */
  constructor(gyroscopeEnabled) {
    super(_GyroscopeUpdatedEvent2.type);
  ...
  },
  {
    moveMode(moveMode, { defValue }) {
      if (moveMode !== "smooth" && moveMode !== "fast") {
        utils_exports.logWarn(`GyroscopePlugin: invalid moveMode`);
        return defValue;
      } else {
        return moveMode;
      }
...
var _GyroscopePlugin = class _GyroscopePlugin2 extends AbstractConfigurablePlugin {
  ...
  static withConfig(config) {
    return [_GyroscopePlugin2, config];
  }
  /**
   * @internal
   */
  init() {
    ...
    this.viewer.addEventListener(events_exports.BeforeRotateEvent.type, this);
  ...
  destroy() {
    ...
    this.viewer.removeEventListener(events_exports.BeforeRotateEvent.type, this);
    this.viewer.removeEventListener(events_exports.BeforeRenderEvent.type, this);
    this.stop();
    (_a = this.controls) == null ? void 0 : _a.disconnect();
   ...
   */
  handleEvent(e) {
    if (e instanceof events_exports.StopAllEvent) {
      this.stop();
    } else if (e instanceof events_exports.BeforeRenderEvent) {
      this.__onBeforeRender();
    } else if (e instanceof events_exports.BeforeRotateEvent) {
  ...
  start(moveMode = this.config.moveMode) {
    return this.state.isSupported.then((supported) => {
      if (supported) {
        ...
        utils_exports.logWarn("gyroscope not available");
      ...
      if (granted) {
        ...
        utils_exports.logWarn("gyroscope not allowed");
        return Promise.reject();
      }
    }).then(() => {
      this.viewer.stopAll();
  ...
  __onBeforeRender() {
    ...
    if (this.state.alphaOffset === null) {
      ...
      if (this.controls.update()) {
        ...
        this.viewer.dynamics.position.goto(target, utils_exports.getAngle(position, target) < 0.01 ? 1 : step);
        if (this.config.roll) {
  ...
  __checkSupport() {
    if ("DeviceOrientationEvent" in window && typeof DeviceOrientationEvent.requestPermission === "function") {
      ...
      return new Promise((resolve) => {
        const listener = (e) => {
          resolve(!!e && !utils_exports.isNil(e.alpha) && !isNaN(e.alpha));
...
@photo-sphere-viewer/gyroscope-plugin/index.module.js:
   ...
   *)
*/
//# sourceMappingURL=@photo-sphere-viewer_gyroscope-plugin.js.map
