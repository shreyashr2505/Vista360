/*!
 * Photo Sphere Viewer / Gyroscope Plugin 5.14.3
...
var _GyroscopePlugin = class _GyroscopePlugin extends AbstractConfigurablePlugin {
  ...
  static withConfig(config) {
    return [_GyroscopePlugin, config];
  }
  /**
   * @internal
   */
...
_GyroscopePlugin.id = "gyroscope";
_GyroscopePlugin.VERSION = "5.14.3";
_GyroscopePlugin.configParser = getConfig;
_GyroscopePlugin.readonlyOptions = ["absolutePosition"];
var GyroscopePlugin = _GyroscopePlugin;
